...
class Kustomization(AppYaml):
    def __init__(self, app: App, shortname: str = None):
        AppYaml.__init__(self, app)
        self.load_yaml() # TODO: what if super constructor does this
    ...
    def config_maps(self):
        return [res for res in self.app.resources if isinstance(res, ConfigMap) and res.need_kustomize()  ]
