...
from .app import YamlObject, Resource
...
class Kustomization(YamlObject):
    def resources(self):
        ...
        return [res for res in self.app.yaml_objects if isinstance(res, Resource) ]

    def config_maps(self):
        return [res for res in self.app.yaml_objects if isinstance(res, KustConfigMap)]
