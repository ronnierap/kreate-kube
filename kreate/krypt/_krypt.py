...
class KryptKonfig(Konfig):
    def __init__(self, main_konfig_path, dict_: dict = None, inkludes=None,
                 tracer=None):
        krypt_functions._konfig = self
        super().__init__(main_konfig_path=main_konfig_path,
                         dict_=dict_, inkludes=inkludes, tracer=tracer
        )
